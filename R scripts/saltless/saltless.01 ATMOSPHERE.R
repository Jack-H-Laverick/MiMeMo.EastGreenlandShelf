...
packages <- c("MiMeMo.tools", "furrr", "ncdf4", "stars")                    # List packages
...
Space <- Window_emep(all_files[1,]$File, w = -30, e = 0, s = 68, n = 84)     # Get values to crop a netcdf file spatially at import. 
